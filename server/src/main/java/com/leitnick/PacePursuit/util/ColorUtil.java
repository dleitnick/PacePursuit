...
public class ColorUtil {
    ...
    public void print(String title) {
        ...
        for (int i = 0; i < titleLinesWithPadding.length; i++) {
            System.out.print(makeBlockGradient(title, RED, GREEN, BLUE, COLOR, 255, 'l'));
            ...
            System.out.println(makeBlockGradient(title, RED, GREEN, BLUE, COLOR, 255, 'r'));
        }
    ...
    private String makeBlockGradient(String title, int red, int green, int blue, char colorChanging, int endOfColor, char sides) {
        ...
        double blockItr = ((double) endOfColor - colorChoice) / (title.length() + paddingHorizontal * 2);
        if (sides == 'l') {
            endOfColor = (int) ((blockItr * paddingHorizontal) + colorChoice - 2* blockItr);
        }
        else if (sides == 'r') {
            colorChoice = endOfColor - (blockItr * paddingHorizontal) + 2 * blockItr;
        }
